...
- **Voice search**: tap the mic icon in the search bar to speak your query; pick your speech language once (prompted on first use), change it anytime via the flag icon next to the mic.
